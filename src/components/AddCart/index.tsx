...
import { useAddCartMutation, useGetCartQuery } from 'features/Auth/auth.service';
...
const AddCart: React.FC<IChildProps> = ({ data }) => {
  ...
  return (
    ...
    >
      {result.isLoading ? <Spinner /> : <IonIcon name="cart" className={`pt-2 text-xl`} />}
    </IconButton>
  );
};
