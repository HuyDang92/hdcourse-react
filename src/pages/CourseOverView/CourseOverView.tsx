...
const CourseOverView = () => {
  ...
  const { data, isFetching, isSuccess } = useGetCourseByIdQuery(idCourse);
    ...
    <div className="relative">
      ...
      <div className="mx-auto  flex max-w-7xl space-x-10  text-darkLight ">
        ...
        <div
          ...
          } sticky top-0 my-10 shadow-border-full bg-white h-fit w-1/3 rounded-2xl transition-all duration-300 ease-in`}
        >
          {isFetching ? (
            <LoadingLocal />
          ) : (
