...
const Footer = () => {
  return (
    <footer className="w-full bg-[#252831] pt-8 text-white ">
      <div className="bg-blueGray-100 relative pb-4 pt-5 mx-auto 2xl:container px-4 xl:px-10">
            ...
            <div className="mb-7 flex flex-col gap-2">
              <div className="flex items-center gap-2 ">
                <p className="text-start text-[0.8rem] font-medium text-[#b8c0c6]">
                  Địa chỉ: Tòa nhà QTSC9 (toà T), đường Tô Ký, <br /> phường Tân
